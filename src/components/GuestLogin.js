  ...
  render() {
    ...
    return (
      <div className="popoverContainer" style={{width: ''}}>
        ...
        <input autoFocus={true} onChange={this.onChangeName} placeholder="your name" style={{ height: '50px', paddingTop: '2px', paddingBottom: '10px', display:'inline-block', verticalAlign: 'middle', width: '300px'}} id="textarea" className="message-composer data-box"/>
        </p>
